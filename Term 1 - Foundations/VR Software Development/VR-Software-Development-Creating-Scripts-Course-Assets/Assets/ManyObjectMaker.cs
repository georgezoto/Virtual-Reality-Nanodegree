...
public class ManyObjectMaker : MonoBehaviour {
	...
	void Start () {
		...
		for (int i = 0; i < 10; i++) {
			...
			//Debug.Log(newSeagull.GetComponentInParent<Shader> ());
			Debug.Log(objectRenderer.material.color);
			//Debug.Log(newSeagull.ToString());
			//Debug.Log(objectRenderer.ToString());
			//Debug.Log(newSeagull.GetComponentInChildren<Renderer>());
